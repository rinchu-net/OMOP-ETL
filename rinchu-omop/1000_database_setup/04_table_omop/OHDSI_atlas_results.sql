----------------------------------------------
-- Atlas / Achilles 分析結果保管テーブル
-- WebAPIからDDL生成
-- http://localhost:8080/WebAPI/ddl/results?dialect=postgresql&schema=results&vocabSchema=production&tempSchema=temp&initConceptHierarchy=true
----------------------------------------------

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_inclusion (cohort_definition_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_inclusion_result (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.heracles_analysis
 (analysis_id int,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.HERACLES_HEEL_results 
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.heracles_results
 (cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
--HINT BUCKET(analysis_id, 64)
CREATE TABLE IF NOT EXISTS :atlasresult_schema.heracles_results_dist
 (cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
	stratum_2 varchar(255),
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.heracles_periods
 (period_id int,
  period_order int,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cohort_sample_element (cohort_sample_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);

CREATE TABLE IF NOT EXISTS :atlasresult_schema.cc_results
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cc_temporal_results (type                 varchar(255),
  fa_type              varchar(255),
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.cc_temporal_annual_results (type                 varchar(255),
      fa_type              varchar(255),
      cc_generation_id     bigint,
      analysis_id          integer,
      analysis_name        varchar(1000),
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.pathway_analysis_codes
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.pathway_analysis_events
 (pathway_analysis_generation_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.pathway_analysis_paths
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
  step_2 BIGINT,
...
CREATE TABLE IF NOT EXISTS :atlasresult_schema.pathway_analysis_stats
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
/*********************************************************************/
CREATE TABLE IF NOT EXISTS :atlasresult_schema.concept_hierarchy
 (concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE :atlasresult_schema.concept_hierarchy;

/********** CONDITION/CONDITION_ERA **********/
INSERT INTO :atlasresult_schema.concept_hierarchy
...
FROM (
	SELECT
		concept_id,
		concept_name
	FROM :production_schema.concept
...
LEFT JOIN (
	...
	FROM :production_schema.concept c1
	INNER JOIN :production_schema.concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN :production_schema.concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN :production_schema.concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN :production_schema.concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
	SELECT
		c2.concept_id   AS rxnorm_ingredient_concept_id,
		c2.concept_name AS RxNorm_ingredient_concept_name
	FROM :production_schema.concept c2
...
FROM (
	SELECT DISTINCT
		concept_id,
		concept_name
	FROM :production_schema.concept c
	WHERE domain_id = 'Measurement'
) m
LEFT JOIN :production_schema.concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN :production_schema.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN :production_schema.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN :production_schema.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN :production_schema.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN :production_schema.concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN :production_schema.concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN :production_schema.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN :production_schema.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN :production_schema.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN :production_schema.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM :production_schema.concept c1
	INNER JOIN :production_schema.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM :production_schema.concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM :production_schema.concept_ancestor ca1
		INNER JOIN :production_schema.concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
		INNER JOIN :production_schema.concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
		INNER JOIN :production_schema.concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
...
TRUNCATE TABLE :atlasresult_schema.heracles_analysis;

insert into :atlasresult_schema.heracles_analysis
...
TRUNCATE TABLE :atlasresult_schema.heracles_periods;

INSERT INTO :atlasresult_schema.heracles_periods (period_id, period_name, period_order, period_type, period_start_date, period_end_date)
...
CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_DEF_ID ON :atlasresult_schema.HERACLES_RESULTS_DIST (cohort_definition_id);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_ID_ANALYSIS_ID ON :atlasresult_schema.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_DEF_ID_DT ON :atlasresult_schema.HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);

CREATE INDEX IF NOT EXISTS HRD_IDX_COHORT_ID_FIRST_RES ON :atlasresult_schema.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_DEF_ID ON :atlasresult_schema.HERACLES_RESULTS (cohort_definition_id);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ID_ANALYSIS_ID ON :atlasresult_schema.HERACLES_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ANALYSIS_CONCEPT ON :atlasresult_schema.HERACLES_RESULTS (cohort_definition_id, analysis_id) WHERE stratum_2 <> '';

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_DEF_ID_DT ON :atlasresult_schema.HERACLES_RESULTS (cohort_definition_id, last_update_time);

CREATE INDEX IF NOT EXISTS HR_IDX_COHORT_ID_FIRST_RES ON :atlasresult_schema.HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX IF NOT EXISTS HH_IDX_COHORT_ID_ANALYSIS_ID ON :atlasresult_schema.HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX IF NOT EXISTS idx_heracles_periods_startdate ON :atlasresult_schema.heracles_periods (period_start_date);

CREATE INDEX IF NOT EXISTS idx_heracles_periods_end_date ON :atlasresult_schema.heracles_periods (period_end_date);

CREATE INDEX IF NOT EXISTS idx_cohort_sample_element_rank ON :atlasresult_schema.cohort_sample_element (cohort_sample_id, rank_value);

CREATE INDEX IF NOT EXISTS idx_pathway_events_combo_id ON :atlasresult_schema.pathway_analysis_events (combo_id);
