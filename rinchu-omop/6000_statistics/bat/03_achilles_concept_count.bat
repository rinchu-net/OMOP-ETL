...
REM ===============================================================
REM  Achilles Concept count execution batch file
REM   Need to be completed executiong Achilles results(R Script).
REM ===============================================================
...
CALL %SETPATH%\ConfirmExecution.bat "Achilles Concept countデータ生成" "%ENVPATH%"
if errorlevel 1 exit /b 0

REM Set target file name
SET TARGET=03_achilles_concept_count
...
REM Show result
CALL %SETPATH%\ShowResult.bat %RESULT% "Achilles Concept countデータ生成" "%LOGFILE%"
